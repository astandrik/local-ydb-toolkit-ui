...
import { Card, Text } from "@/components/GravityUI/GravityUI";
    ...
    <Card view="raised" className="ask-ai-panel">
      <div className="ask-ai-panel__content">
        <div className="ask-ai-panel__body">
          <Text variant="subheader-2" as="h2" className="ask-ai-panel__title">
            {label}
          </Text>
          <Text variant="body-1" color="secondary" className="ask-ai-panel__help">
            {helperText}
          </Text>
        </div>
...
type AskAIProviderIconProps = SVGProps<SVGSVGElement> & {
  provider: AskAIProviderId;
};

function AskAIProviderIcon({ provider, ...props }: AskAIProviderIconProps) {
  switch (provider) {
    case "chatgpt":
      return <ChatGPTMark {...props} />;
    case "perplexity":
      return <PerplexityMark {...props} />;
    case "claude":
      return <ClaudeMark {...props} />;
    case "google-ai-mode":
      return <GoogleAIModeMark {...props} />;
    case "grok":
      return <GrokMark {...props} />;
  }
}
...
function GoogleAIModeMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" focusable="false" {...props}>
      <path
        fill="#3186ff"
